# Generic Connectable Resource

#### Version 1.0.0


## Introduction
This Shell Standard is a project used to define a standard for generic Shells that integrate with CloudShell, shells that don't match other CloudShell standards, and should be modeled as one-level resource only. The specifications of this shell include the most common elements that shells usually have such as: vendor, location etc.
...
Version | Date | Notes
--- | --- | ---
1.0.0 | 2019-2-26 | First release of the Generic Connectable Resource standard
...
- Family: CS_GenericConnectableResource, Model: DUT
...
Family | Rules
--- | ---
CS_GenericConnectableResource | Searchable, Locked By Default, Connectable


#### Resource Name and Address
Family | Model | Resource Name | Resource Address
--- | --- | --- | ---
CS_GenericConnectable_Resource | [The shell Model] | The IP address of the resource
